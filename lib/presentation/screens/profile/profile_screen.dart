...
// ── Unread notifications count (real from Firestore) ──────────────────────────
            ...
            child:
              ...
              SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text('Sign In / Create Account',
                        style: GoogleFonts.syne(fontWeight: FontWeight.w700)),
      ...
      child: Column(children: [
        ...
        if (isAgent) ...[
          ...
          Row(children: [
            ...
            _StatBox('${user.rating?.toStringAsFixed(1) ?? '—'}', 'Rating'),
            const SizedBox(width: 8),
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              child: const Row(children: [
                ...
                Expanded(
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                      Text('Get Verified Agent Badge',
                          style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.w800,
                              fontSize: 14)),
                      Text('Build trust · Get more inquiries',
                          style:
        ...
        GestureDetector(
          child: Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                  child: Text('Upgrade to Premium Agent',
                      style: GoogleFonts.syne(
                          fontSize: 13,
                          fontWeight: FontWeight.w800,
                          color: Colors.white))),
        ...
        _MenuSection('MY ACTIVITY', [
          _MenuItem(Icons.home_outlined, AppColors.primaryPale2,
              AppColors.primary, 'My Listings',
              badge: (user.totalListings ?? 0) > 0 ? '${user.totalListings}' : null,
              onTap: () => context.push('/profile/listings')),
          _MenuItem(Icons.favorite_border_rounded, const Color(0xFFFEE2E2),
              AppColors.error, 'Saved Properties',
          ...
          Consumer(builder: (ctx, ref2, _) {
            ...
            final pendingCount = uid != null
                ...
                : 0;
            return _MenuItem(Icons.calendar_today_outlined, const Color(0xFFFEF3C7),
                AppColors.gold, 'Inspection Bookings',
                badge: pendingCount > 0 ? '$pendingCount' : null,
                onTap: () => context.push('/bookings'));
          }),
          Consumer(builder: (ctx, ref2, _) {
            final unread = ref2.watch(totalUnreadProvider).value ?? 0;
            return _MenuItem(Icons.chat_bubble_outline_rounded, AppColors.primaryPale2,
                AppColors.primary, 'Messages',
        ...
        _MenuSection('ACCOUNT', [
          _MenuItem(Icons.verified_user_outlined, AppColors.primaryPale2,
              AppColors.primary, 'Verification Status',
              trailing: Container(
                  padding:
          ...
          Consumer(builder: (ctx, ref2, _) {
            ...
            final unreadNotifs = uid != null
                ...
                : 0;
            return _MenuItem(Icons.notifications_outlined, const Color(0xFFEFF6FF),
                AppColors.info, 'Notifications',
                badge: unreadNotifs > 0 ? '$unreadNotifs' : null,
                onTap: () => context.push('/notifications'));
          }),
          _MenuItem(Icons.settings_outlined, AppColors.bg, AppColors.text2,
              'Settings',
        ...
        _MenuSection('SUPPORT & INFO', [
          _MenuItem(Icons.verified_user_outlined, AppColors.primaryPale2,
              AppColors.primary, 'How We Verify Agents',
              onTap: () => context.push('/info/how-we-verify')),
          _MenuItem(Icons.security_outlined, const Color(0xFFFEF3C7),
              AppColors.gold, 'Safety Tips',
              onTap: () => context.push('/info/safety')),
          _MenuItem(Icons.help_outline_rounded, const Color(0xFFEFF6FF),
              AppColors.info, 'FAQ & Help',
              onTap: () => context.push('/info/faq')),
          _MenuItem(Icons.info_outline_rounded, AppColors.bg, AppColors.text2,
              'About Propsure',
...
class _MenuItem extends StatelessWidget {
  ...
  final VoidCallback onTap;
  const _MenuItem(this.icon, this.bgColor, this.iconColor, this.label,
      {this.badge, this.trailing, required this.onTap});
  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onTap,
